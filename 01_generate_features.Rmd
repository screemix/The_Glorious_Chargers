...
#missing_train <-  missing_train[, list(months_with_order = sum(target),
...
train_v1 <- rbind(missing_train, train_v1)
...
train_v1_all <- rbind(missing_train, train_v1_all)
...
fwrite(train_v1, '01_preprocessed_data/train_v14.csv')
fwrite(submission_feat, '01_preprocessed_data/submission_features.csv')
fwrite(train_v1_all, '01_preprocessed_data/train_all_v14.csv')
